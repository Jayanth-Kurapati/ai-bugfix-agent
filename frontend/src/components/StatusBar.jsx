...
const STATUS_DISPLAY = {
  ...
  running:           { label: 'Running',           className: 'badge-running',           icon: Loader2, spin: true },
  ...
  blocked:           { label: 'Blocked',           className: 'badge-blocked',           icon: AlertTriangle },
  model_unavailable: { label: 'Model Unavailable', className: 'badge-model-unavailable', icon: Unplug },
};
    ...
    <div className={`status-bar glass-card animate-fade-in ${isTerminal ? 'terminal' : ''}`} id="status-bar">
      <div className="status-row">
        <div className={`badge ${display.className}`} id="job-status-badge">
          <IconComponent size={14} className={display.spin ? 'badge-spinner' : ''} />
        ...
        <div className="status-stats">
          <div className="stat" id="iteration-count">
            <span className="stat-label">
              <Layers size={11} className="stat-icon" />
              Iteration
            </span>
          ...
          <div className="stat" id="llm-call-count">
            <span className="stat-label">
              <Cpu size={11} className="stat-icon" />
              LLM Calls
            </span>
      ...
      {status === 'model_unavailable' && (
        <div className="status-model-msg animate-fade-in">
          <Unplug size={16} className="model-msg-icon" />
